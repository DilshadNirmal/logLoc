const SensorButton = ({ sensorId, voltage, isSelected, onClick }) => {
  ...
  return (
    ...
    >
      <div className="text-sm md:text-xs font-medium tracking-wider opacity-55 mb-0.5">
        S{sensorId}
      </div>
      <div className="text-lg md:text-xs 2xl:text-lg font-semibold tracking-wider mb-1">
        {voltage?.toFixed(2) || "--"}
      </div>
