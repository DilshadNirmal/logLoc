  ...
  return (
    <div className="flex flex-col sm:flex-row gap-2 md:gap-1 2xl:gap-2 mx-2 md:mx-1 2xl:mx-2 items-center">
      <div className="flex gap-1">
        <p className="text-sm md:text-[8px] xl:text-[10px] 2xl:text-sm">
          Active:{" "}
          <span className="text-primary font-medium text-sm md:text-[9px] xl:text-[10px] 2xl:text-base ml-1">
            {side === "A"
      ...
      <p className="text-sm md:text-[8px] xl:text-[10px] 2xl:text-sm">
        Lt.Upd:{" "}
        <span className="text-primary font-medium text-sm md:text-[8px] xl:text-[10px] 2xl:text-base ml-1">
