...
const ActivitiesLog = () => {
  ...
  const fetchActivities = async () => {
    ...
    try {
      ...
      const response = await axiosInstance.get("/auth/admin/activities", { params });
      ...
      if (error.response?.status === 403) {
        setError("You don't have permission to view activities. Only super admins can access this page.");
      } else {
  ...
  return (
    <div className="p-4 md:p-6">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-white">Activities Log</h1>
      </div>
